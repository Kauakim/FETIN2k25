...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
  ...
  errorBuilder: (context, state) => InicialWidget(),
  routes: [
    FFRoute(
      name: '_initialize',
      path: '/',
      builder: (context, _) => InicialWidget(),
    ),
    FFRoute(
    ...
    FFRoute(
      ...
      path: HomeMapaWidget.routePath,
      builder: (context, params) => HomeMapaWidget(),
    ),
    FFRoute(
    ...
    FFRoute(
      name: TaskManagerWidget.routeName,
      path: TaskManagerWidget.routePath,
      builder: (context, params) => TaskManagerWidget(),
    ),
    FFRoute(
